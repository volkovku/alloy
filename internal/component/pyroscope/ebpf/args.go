...
type Arguments struct {
	...
	BPFFSRoot                string                 `alloy:"bpf_fs_root,attr,optional"`
	OBIProcessContextEnabled bool                   `alloy:"obi_process_context_enabled,attr,optional"`
	LoadProbe                bool                   `alloy:"load_probe,attr,optional"`
	ProbeLinks               []string               `alloy:"probe_links,attr,optional"`
...
type DeprecatedArguments struct {
	...
	// deprecated: use probe_links instead.
